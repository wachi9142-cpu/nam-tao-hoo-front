...
export const grocery: GroceryCategory[] = [
  ...
  },
  {
    ...
    items: ["ยาสามัญประจำบ้าน", "สบู่ / ครีมอาบน้ำ", "แชมพู / ครีมนวดผม", "ยาสีฟัน / แปรงสีฟัน", "ผ้าอนามัย", "ครีมกันแดด"],
    groups: [
  ...
  { title: "สัตว์เลี้ยง", emoji: "🐱", items: ["อาหารเม็ดแมว", "ขนมแมว", "แมวเลีย", "แป้งแมว", "แป้งหมา"] },
